...
#print out suspicious transactions (ML anomaly detection based)
def print_anomalies(dataframe, pred_column='iso_pred', anomaly_label=-1):
    """
    Print all features of transactions flagged as anomalies.
    """
    anomalies = dataframe[dataframe[pred_column] == anomaly_label]
    print("\n[+] All features for flagged anomalies:\n")
    print(anomalies)
